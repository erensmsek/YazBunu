...
çalışma zamanında indirilmesindeki güvenilmezliği ve pyannote 4.x'in artık bu
gated pakete bağımlı olmasını aşmak için doğrudan repoya gömer; kullanıcının
herhangi bir HF hesabı veya token'a ihtiyacı olmaz.
